...
//=========  (Mon Sep 29 14:06:05 2014) by ROOT version5.34/21
  ...
  gStyle->SetLabelFont(132,"xyz");
   ...
   TLatex *   tex = new TLatex(0.08,0.57,"#delta u^{[0,1]}");
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
   ...
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,1,0.39);
   gre->SetPointError(0,0,0,0.2,0.16);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,2,0.39);
   gre->SetPointError(0,0,0,0.15,0.15);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,3,0.39);
   gre->SetPointError(0,0,0,0.12,0.18);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,4,0.31);
   gre->SetPointError(0,0,0,0.12,0.16);
