...
//=========  (Mon Sep 29 14:06:05 2014) by ROOT version5.34/21
  ...
  gStyle->SetLabelFont(132,"xyz");
   ...
   tex->Draw();
          tex = new TLatex(0.6,0.03,"#delta d^{[0,1]}");
   tex->SetLineWidth(2);
   ...
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,-0.22,2);
   gre->SetPointError(0,0.10,0.31,0,0);
  
 


   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,-1.05,0.25);
 ...
 gre->Draw("acp");
    ...
    TText t;
    // draw labels along y
    x = nemo_1->GetUxmin() -0.9 - 0.1*gre->GetXaxis()->GetBinWidth(1);
    //cout << x << endl;
    t.SetTextAlign(32);
    t.SetTextSize(0.05);
    t.SetTextAngle(0);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,-0.41,3);
   gre->SetPointError(0,0.52,0.52,0,0);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,-0.25,4);
   gre->SetPointError(0,0.1,0.3,0,0);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,-0.27,5);
   gre->SetPointError(0,0.1,0.1,0,0);
   ...
   gre->SetMarkerStyle(8);
   gre->SetMarkerSize(3.);
   gre->SetPoint(0,-0.22,1);
   gre->SetPointError(0,0.10*0.2938,0.31*0.2938,0,0);
   gre->Draw("pl");
