...
for i in range(0,2):
    for j in range(0,2):
        ...
        for k in range(0,2):
            ...
            out_filename = './hessian/%s_%s_%s.out'%(exps[i], tgts[j], pids[k])
            ...
            for l in range(1, len(lines)):
                ...
                if os.path.isfile(gen_file):
                    ...
                    ChiSQ = float(new_value[2])
                else:
                    print 'count not find the result! %s'%gen_file
                    ChiSQ = -11111
                    print >> of0, '%14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e %14.5e'\
