...
int main(int argc, char **argv)
{
	...
	if(GENERATE_DATA){
		...
		filename.Form("./%s_%s_%s/%s_data_%s_%s_%d.dat",EXPERIMENT.Data(),TARGET.Data(),PARTICLE.Data(),EXPERIMENT.Data(),TARGET.Data(),PARTICLE.Data(),set_used);
		...
		filename_write.Form("./%s_%s_%s/transversity_u_%d.dat",EXPERIMENT.Data(),TARGET.Data(),PARTICLE.Data(),set_used);
		...
		filename_write.Form("./%s_%s_%s/transversity_d_%d.dat",EXPERIMENT.Data(),TARGET.Data(),PARTICLE.Data(),set_used);
