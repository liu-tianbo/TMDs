...
int read_data(int target_flag=3, int particle_flag=1, int flag_t=0){
	...
	filename.Form("../data/solid_he3_results_wider2/%s_%s_%d_%d.dat",target.Data(),particle.Data(),Q2_flag,z_flag);
...
////////////////////////////////////////////////   
   ...
   TString filename="./results/solid_unpolarised_3he_pip.dat"; 
  ...
  for( int i = 0; i < number_pip_bins; i++){
   ...
   filename ="./results/solid_unpolarised_3he_pim.dat";
